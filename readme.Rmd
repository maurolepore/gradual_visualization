...
4. Download the conference materials as a ZIP file and extract the files there as a folder on your computer. Double click on the **gradual_visualization.Rproj** file to open up an RStudio project containing the files needed for the workshop.  
