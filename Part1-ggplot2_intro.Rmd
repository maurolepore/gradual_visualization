...
**Note**:  To focus on only the rows in the data frame corresponding to 1992 we've created a dataset and saved the file as a CSV (basic spreadsheet) file in the `data` folder. We'll see how to use the `filter` function from `dplyr` to perform this subsetting in the afternoon workshop.
